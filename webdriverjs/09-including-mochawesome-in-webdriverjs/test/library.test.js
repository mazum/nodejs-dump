//COMMAND- mocha test --reporter mochawesome --reporter-options autoOpen=truemocha test --reporter mochawesome --reporter-options autoOpen=true
...
describe('library app scenarios', function () {
    ...
    it('submitting email shows an alert', function () {
        var submitBtn = driver.findElement(By.css('.btn-lg'));
        driver.findElement(By.css('input')).sendKeys('uscom');
        submitBtn.click();
